...
namespace Đồ_án.Migrations
{
    ...
    [Migration("20230812163552_Migration5")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Đồ_án.Areas.Admin.Models.TaikhoanNguoiDung", b =>
                {
                    b.Property<string>("CMND_CCCD")
                        .HasMaxLength(100)
                        .IsUnicode(true)
            ...
            modelBuilder.Entity("Đồ_án.Areas.Admin.Models.TaikhoanNguoiDung", b =>
                {
                    b.HasOne("Đồ_án.Areas.Admin.Models.NguoiThue", "nguoiThue")
                        .WithOne("taikhoanNguoiDung")
                        .HasForeignKey("Đồ_án.Areas.Admin.Models.TaikhoanNguoiDung", "CMND_CCCD")
                        .HasPrincipalKey("Đồ_án.Areas.Admin.Models.NguoiThue", "CMND_CCCD")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_TaiKhoanNguoiDung_NguoiThue");
